...
public class ShopView {
    public static void printShopCommandsToHelp() {
        ...
        System.out.println("2- search [item name | card name] : to searching on collectionShop");
        System.out.println("3- search collection [item name | card name] : to searching on your collection");
